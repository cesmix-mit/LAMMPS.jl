...
function test_pair(lmp_native, lmp_julia, testset)
    ...
    potential_native = gather(lmp_native, "c_potential", LAMMPS_DOUBLE)
    potential_julia = gather(lmp_julia, "c_potential", LAMMPS_DOUBLE)
    forces_native = gather(lmp_native, "f", LAMMPS_DOUBLE_2D)
    forces_julia = gather(lmp_julia, "f", LAMMPS_DOUBLE_2D)
    virial_native = gather(lmp_native, "c_virial", LAMMPS_DOUBLE_2D)
    virial_julia = gather(lmp_julia, "c_virial", LAMMPS_DOUBLE_2D)
